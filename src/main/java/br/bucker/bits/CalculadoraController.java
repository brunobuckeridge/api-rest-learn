...
public class CalculadoraController {
	...
	public String soma(@PathVariable String numberOne, @PathVariable String numberTwo) throws Exception {
		return  String.format(template, "soma", DoubleUtils.validaNumero(numberOne) + DoubleUtils.validaNumero(numberTwo));
	}
	
	@GetMapping("/sub/{numberOne}/{numberTwo}")
	public String sub(@PathVariable String numberOne, @PathVariable String numberTwo) throws Exception {
		return  String.format(template, "subtração", DoubleUtils.validaNumero(numberOne) - DoubleUtils.validaNumero(numberTwo));
	}
	
	@GetMapping("/mult/{numberOne}/{numberTwo}")
	public String mult(@PathVariable String numberOne, @PathVariable String numberTwo) throws Exception {
		return  String.format(template, "multiplicação", DoubleUtils.validaNumero(numberOne) * DoubleUtils.validaNumero(numberTwo));
	}
	
	@GetMapping("/div/{numberOne}/{numberTwo}")
	public String div(@PathVariable String numberOne, @PathVariable String numberTwo) throws Exception {
		return  String.format(template, "divisão", DoubleUtils.validaNumero(numberOne) / DoubleUtils.validaNumero(numberTwo));
	}
	...
	public String med(@PathVariable String numberOne, @PathVariable String numberTwo) throws Exception {
		return  String.format(template, "media", (DoubleUtils.validaNumero(numberOne) + DoubleUtils.validaNumero(numberTwo)) / 2);
	}
	
	@GetMapping("/raiz/{number}")
	public String raiz(@PathVariable String number) throws Exception {
		return  String.format(template, "raiz quadrada", Math.sqrt(DoubleUtils.validaNumero(number)));
	}
